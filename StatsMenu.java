...
public class StatsMenu extends BackgroundPanel {
	...
	private void fillTabLevels(JPanel tab, GridBagConstraints c){
		...
		JComboBox<String> levels = new JComboBox<String>(a);
		c.gridx = 1;
		tab.add(levels, c);
        //-------------------------------------------------------------------------------------------------	
		//Age Combo Box
		...
		tab.add(new JLabel("Select Age: "),c);
		
		Vector<String> m = new Vector<String>();
		for(int i=3;i<14;i++){
			m.add(Integer.toString(i));
		}
		JComboBox<String> ages = new JComboBox<String>(m);
		c.gridx++;
		tab.add(ages, c);
		
		c.gridx++;
		tab.add(new JLabel("Average time:"));
		c.gridx++;
		tab.add(new JLabel("88.4 seconds"));
		//------------------------------------------------------------------------
		//Rank		
		c.ipadx = 0;
		c.gridx = 0;
		...
		c.gridx = 4;
		c.gridy=5;
		tab.add(new JLabel("8 years old"), c);
		c.gridy+=2;
		tab.add(new JLabel("7 years old"), c);
		c.gridy+=2;
		tab.add(new JLabel("9 years old"), c);
		//------------------------------------------------------------------------
		//Fastest Times
		c.gridx = 5;
		c.gridy=5;
		tab.add(new JLabel("22.2 seconds"), c);
		c.gridy+=2;
		tab.add(new JLabel("34.7 seconds"), c);
		c.gridy+=2;
		tab.add(new JLabel("120.3 seconds"), c);
		//-------------------------------------------------------------------------------------------------		
		// Separators
		c.insets = new Insets(0,0,0,0);
	    c.gridwidth = 6;
